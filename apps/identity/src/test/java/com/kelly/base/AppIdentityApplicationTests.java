...
@DisplayName("AppIdentityApplicationTests")
class AppIdentityApplicationTests {
    private final ApplicationModules modules = ApplicationModules.of(AppIdentityApplication.class);

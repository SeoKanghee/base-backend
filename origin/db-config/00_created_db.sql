...
INSERT INTO `base_backend`.`users` (login_id, password, name, role, status, department, created_at, updated_at) VALUES
    ('master', 'FfihV0TUqJzX+Is+WvMY5CckI1UlHP3Xg7JTuNDCOT9wvUurU9Wm6Ko=', '시스템 관리자', 'SITE_MANAGER', 'ACTIVE', '마스터 계정', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('admin', 'QRgAlRgDFkGhpci1h4CtkC/j3h/eqktdxg+SfpiZqcrj+Fv4DIFb9g==', '서비스 엔지니어', 'SERVICE_ENGINEER', 'ACTIVE', 'SE', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));

...
CREATE TABLE `base_backend`.`users` (
    ...
    locked_at DATETIME(6) NULL COMMENT '잠김 시간',
...
-- init data
INSERT INTO `base_backend`.`users` (login_id, password, name, role, status, fail_count, is_temp, department, password_expired_at, created_at, updated_at) VALUES
